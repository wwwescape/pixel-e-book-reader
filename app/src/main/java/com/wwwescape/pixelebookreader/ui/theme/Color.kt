...
// Light color scheme — the app's static (non-dynamic-color) light palette, matching Pixel
// Info's palette exactly (a violet seed) per sibling-app convention.
...
// Dark color scheme, matching Pixel Info's dark palette. The "fixed" roles above are identical
